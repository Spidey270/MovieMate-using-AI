    ...
    return (
        <div className="min-h-screen bg-secondary text-white pb-20">
            ...
            <div className="pt-24 mx-auto max-w-6xl px-4">
                <h1 className="text-3xl font-bold mb-8 border-b border-gray-800 pb-4">My Wishlist</h1>

                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                    {wishlist.map(item => (
                        <div key={item.id} className="bg-zinc-900/50 border border-white/5 rounded-xl p-4 transition-all hover:bg-zinc-900 group flex flex-col">
                            ...
                            <Button
                                ...
                                onClick={async () => {
                                    try {
                                        ...
                                        setWishlist(wishlist.filter(w => w.movie_id !== item.movie_id))
                                    } catch (e) {
                    ...
                    {wishlist.length === 0 && (
                        <div className="col-span-full text-center py-20 bg-zinc-900/30 rounded-2xl border border-white/5">
                            ...
                            <p className="text-gray-500 mb-6">Keep track of movies you want to watch soon.</p>
                            <Link to="/movies">
                                <Button className="bg-primary hover:bg-red-700">Explore Movies</Button>
                            </Link>
                        </div>
                    )}
                </div>
