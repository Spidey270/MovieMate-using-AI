            ...
            <div className="pt-24 mx-auto max-w-6xl px-4">
                <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="text-sm text-gray-400 bg-zinc-900 px-4 py-2 border border-gray-800 rounded-full">
                        Total Records: <span className="text-white font-bold">{users.length}</span>
                    </div>
                </div>
                ...
                <div className="bg-zinc-900 rounded-xl overflow-hidden shadow-2xl border border-gray-800">
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-sm text-gray-300">
                            ...
                            <tbody>
                                {users.map((u) => (
                                    <tr key={u.id} className="border-b border-gray-800 hover:bg-zinc-800/50 transition">
                                        ...
                                        <td className="px-6 py-4">
                                            {u.is_admin ? (
                                                <span className="bg-amber-500/20 text-amber-400 py-1 px-3 rounded-full text-xs font-bold border border-amber-500/30">Admin</span>
                                            ) : (
                                                <span className="bg-blue-500/20 text-blue-400 py-1 px-3 rounded-full text-xs font-bold border border-blue-500/30">User</span>
                                            )}
                                        </td>
