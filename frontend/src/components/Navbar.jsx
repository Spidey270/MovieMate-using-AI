                        ...
                        {showSearch && searchResults.length > 0 && (
                            <div className="absolute top-full right-0 mt-2 w-64 bg-zinc-900 shadow-xl rounded overflow-hidden">
                                {searchResults.map(movie => (
                                    ...
                                    >
                                        <img src={movie.poster_path ? `https://image.tmdb.org/t/p/w200${movie.poster_path}` : "https://via.placeholder.com/50"}
                                            className="w-10 h-14 object-cover rounded" alt={movie.title} />
                                        <div className="text-sm text-white">
                                            <div className="font-bold">{movie.title}</div>
                                            <div className="text-xs text-gray-400">{movie.release_date?.substring(0, 4)}</div>
                                        </div>
                                    </Link>
                                ))}
                            </div>
                            ...
                            <div ref={notifRef} className="relative">
                                ...
                                {showNotifs && (
                                    <div className="absolute right-0 mt-2 w-80 rounded bg-black/95 p-2 shadow-2xl ring-1 ring-white/20 max-h-96 overflow-y-auto">
                                        <div className="p-2 border-b border-gray-800 font-bold mb-2">Notifications</div>
